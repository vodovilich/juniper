...
set interfaces ge-0/0/1 unit 601 family vpls
...
set interfaces ge-0/0/2 unit 601 family vpls
...
set routing-instances Customer1 protocols vpls site Customer1-1 interface ge-0/0/1.601
set routing-instances Customer1 protocols vpls site Customer1-1 site-identifier 1
set routing-instances Customer1 protocols vpls site Customer1-3 interface ge-0/0/2.601
set routing-instances Customer1 protocols vpls site Customer1-3 site-identifier 3
set routing-instances Customer1 protocols vpls site-range 100
...
set interfaces lo0 unit 0 family mpls
set routing-instances Customer1 instance-type vpls
set routing-instances Customer1 protocols vpls site Customer1-2 interface ge-0/0/1.601
set routing-instances Customer1 protocols vpls site Customer1-2 site-identifier 2
set routing-instances Customer1 protocols vpls site Customer1-4 interface ge-0/0/2.601
set routing-instances Customer1 protocols vpls site Customer1-4 site-identifier 4
set routing-instances Customer1 protocols vpls site-range 100
set routing-instances Customer1 interface ge-0/0/1.601
set routing-instances Customer1 interface ge-0/0/2.601
